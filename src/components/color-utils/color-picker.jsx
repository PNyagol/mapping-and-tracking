...
import { colorPickerClasses } from './classes.js';
...
const ItemContainer = styled('span', {
  ...
  width: hasSelected ? 'calc(var(--item-size) - 8px)' : 'calc(var(--item-size) - 16px)',
  height: hasSelected ? 'calc(var(--item-size) - 8px)' : 'calc(var(--item-size) - 16px)',
...
const ItemIcon = styled(Iconify, {
  ...
  width: hasSelected ? 'calc(var(--item-size) / 2.4)' : 0,
  height: hasSelected ? 'calc(var(--item-size) / 2.4)' : 0,
